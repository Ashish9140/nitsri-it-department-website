                ...
                <div className=" container-fluid container2">
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-4 border-color d-flex justify-content-center ">
                                Name and Research Area
                            </div>
                            <div className="col-5 border-color-contact d-flex justify-content-center">
                                Contact
                            </div>
                        </div>
                    </div>
                    <div className="designtions container">
                        <div className="row">
                            <div className="col bg-designations-color p-2 d-flex justify-content-center">
                            ...
                            <div className="col-4 border-color-2 p-2 fontem" style={{ lineHeight: "20px" }}>
                                ...
                                <div className="row">
                                    <div className="col-12">
                                        <p>Assistant Professor </p>
                                        <p className="d_block"> PhD. </p>
                                        <p className="d_block2">Digital Image Processing, Network Security, Computer Vision, Medical Image Analysis.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-4 border-color-2 p-2 fontem" style={{ lineHeight: "20px" }}>
                                ...
                                <div className="row">
                                    <div className="col-12">
                                        ...
                                        <p className="d_block2">Data Algorithmics, Probabilistic Analysis of Networks, Distributed Computation, Network and Data Science.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-5 border-color-contact-2 d-flex justify-content-center fontem">
                    ...
                    <div className="designtions container">
                        <div className="row">
                            ...
                            <div className="col-4 border-color-2 p-2 fontem" style={{ lineHeight: "20px" }}>
                                <div className="row ">
                                    <div className="col-12"><a href="/" target="_blank" style={{ textDecoration: "none" }}>&nbsp;Dr. Janib Ul Bashir
                                ...
                                <div className="row">
                                    <div className="col-12">
                                        <p>Assistant Professor </p>
                                        <p className="d_block"> PhD (IIT Delhi)</p>
                                        <p className="d_block2">Computer Architecture, Parallel Programming, on-chip security, on-chip networks</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-5 border-color-contact-2 d-flex justify-content-center fontem">
                            ...
                            <div className="col-4 border-color-2 p-2 fontem" style={{ lineHeight: "20px" }}>
                                ...
                                <div className="row">
                                    <div className="col-12">
                                        <p>Assistant Professor </p>
                                        <p className="d_block"> PhD</p>
                                        <p className="d_block2">Algorithms, Swarm Optimization Algorithms, Machine learning optimization</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-5 border-color-contact-2 d-flex justify-content-center fontem">
